...
public class ShoppingCartController {
	...
	public ResponseEntity<ShoppingCartDto> getShoppingCartById(@PathVariable final BigInteger id) {
	...
	public ResponseEntity<ShoppingCartDto> getShoppingCartByUserId(@PathVariable final BigInteger userId) {
	...
	public ResponseEntity<?> createShoppingCart(@RequestBody @Valid final FormShoppingCartDto formDto, UriComponentsBuilder builder) {
	...
	public ResponseEntity<?> deleteShoppingCart(@PathVariable final BigInteger userId) {
	...
	public ResponseEntity<ShoppingCartDto> updateShoppingCartContent(@RequestBody @Valid final FormShoppingCartDto formUpdate) {
